...
function App() {
    ...
    const ChangeTest = (event) => {
        ...
        if (targetId === 'model') {
            ...
            setCar({ ...car, image: targetValue, modelName: msg, model: targetValue })

            // //get(key) : key를 사용하여 해당 요소의 value 를 반환 받습니다.

        } else if (targetId === 'color') {
            //전개연산자를 사용하여 color이외의 모든데이터를 보존합니다.
    ...
    return (
        <div className="App">
            ...
            <p>
                ...
                색상의 {car.year}년식 {car.modelName}모델
            </p>
            {car.comment}
            <br /><br />
