    ...
    return (
        ...
        <Card>
            ...
            <Card.Body>
                ...
                <Content contents={products} onClickToContent={ClickArrived} categories={categories} onOrderByClick={ClickOrderBy} orderInfo={orderInfo} onChangeCategory={ChangeCategory} />
            </Card.Body>
            <CardBody>
                <Switcher
                    mode={mode}
